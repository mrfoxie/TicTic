...
public class PermissionUtils {
    ...
    public void takeContactLocationPermission()
    {
    ...
    public void showContactLocationPermissionDailog(String message)
    {
        List<String> permissionStatusList=new ArrayList<>();
    ...
    public boolean isContactLocationPermissionGranted()
    {
        int contactPermission= ContextCompat.checkSelfPermission(activity, Manifest.permission.READ_CONTACTS);
        ...
        return (contactPermission== PackageManager.PERMISSION_GRANTED && coursePermission== PackageManager.PERMISSION_GRANTED && finePermission== PackageManager.PERMISSION_GRANTED);
    }
}
